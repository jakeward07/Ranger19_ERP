...
$sql="SELECT * FROM invh h INNER JOIN cumf c ON c.cu_id = h.vh_cust INNER JOIN stmf s ON s.st_code = h.vh_site WHERE h.vh_inv = $q AND h.vh_site = $site_cd"; 
...
?>
   <tr class="tr">
    ...
    <?php  }} else {
        echo "<h1>No Invoice exists with $q-$site_cd</h1>";
    }
    ?>