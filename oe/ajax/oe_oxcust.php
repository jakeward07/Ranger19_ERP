...
$sql="SELECT * FROM orhd o INNER JOIN cumf c ON c.cu_id = o.oh_cust WHERE o.oh_cust = $q AND o.oh_site = $site_cd AND o.oh_status = 'Open' ORDER BY o.oh_order DESC"; 
...
?>
   <tr class="tr">
    ...
    <?php  }} else {
        echo "<h1>No Order exists for $q</h1>";
    }
    ?>